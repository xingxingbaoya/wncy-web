<template>
  <el-main class="content">
    <el-card class="play-content" :body-style="{ padding:'15px' }" shadow="never">
      ...
      <el-col :span="12" class="play-right">
        <div>
          ...
          <p class="play-status">
            <span class="p-ft">活动时间: </span><span class="mr20">{{ item.createTime }}</span>
          </p>
        </div>
...
.play-content{
  padding: 100px calc((100% - 1245px) / 2) 68px ;
  background: #fff;
