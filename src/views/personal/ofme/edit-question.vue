        ...
        <el-card class="box-form" :body-style="{ padding: '30px' }">
          ...
          <el-form ref="form1" :model="form1" :rules="form1Rule" label-width="120px" label-position="left">
            <el-row>
              <el-col :span="13">
                <el-form-item label="问题标题" prop="title">
                  <el-input v-model="form1.title" placeholder="问题标题" />
                </el-form-item>
              </el-col>
            ...
            <el-row justify="flex-start" type="flex">
              <el-button type="primary" class="submit-form" @click="postQuestionDetail"><span class="icon-text">确认保存</span></el-button>
...
import { getBBsColumnList, getBBsDetail, getBBsQsDetail, updateMyManuscript, updateMyQuestion } from '@/api/bbshall'
  ...
  methods: {
    ...
    postQuestionDetail() {
      Promise.all(this.valiaForm(['form1'])).then(res => {
        ...
        updateMyQuestion(param2Form({ ...this.form1 })).then(res => {
          if (res.code == '0000') {
