            ...
            <el-row>
              ...
              <el-col :span="9" :offset="2">
                <el-form-item label="文章状态">
                  <span>{{ form1.status | formatAuth }}</span>
                </el-form-item>
              </el-col>
              <el-col :span="11">
              ...
              <el-col :span="24">
                <el-form-item label="文章内容">
                  <div class="maxHeight" v-html="form1.content" />
                </el-form-item>
              </el-col>
            ...
            <el-row>
              <el-col :span="22">
                <el-form-item label="审核状态">
                  <span :class="{'reject-color':form1.status == 3}">{{ form1.status | formatAuth }}</span>
                </el-form-item>
              </el-col>
              <el-col v-show="form1.status == 3" :span="22">
                <el-form-item label="驳回原因">
                  <span>{{ form1.backRemark }}</span>
                </el-form-item>
              </el-col>
            </el-row>

            <el-row justify="flex-start" type="flex">
              <el-button type="primary" class="submit-form" @click="goedit"><span class="icon-text">编辑文章</span></el-button>
              <el-button type="primary" class="cancel-form" @click="godelete"><span class="icon-text">删除文章</span></el-button>
            </el-row>
          </el-form>
        </el-card>
      </el-col>
...
import { deleteMyManuscript, getBBsDetail } from '@/api/bbshall'
export default {
  ...
  methods: {
    ...
    godelete() {
      ...
      this.$confirm('确认是否删除?', '提示', {
        ...
        this.loading = true
        deleteMyManuscript(id).then(res => {
          if (res.code == '0000') {
