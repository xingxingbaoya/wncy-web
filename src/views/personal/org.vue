      ...
      <el-form label-width="150px" label-position="left" :model="item">
        <el-row>
          ...
          <el-col :span="9" :offset="2">
            <el-form-item label="机构logo：" label-width="120px">
              <img v-if="item.avatar" :src="item.avatar" alt="" class="avatar">
              <svg-icon v-else icon-class="center-logo" class-name="avatar" />
            </el-form-item>
          </el-col>

          <el-col :span="13" class="mtf60">
            <el-form-item label="机构性质：">
              <span>{{ item.institutionalNature | formatInsnature }}</span>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="13">
            <el-form-item label="机构注册地：">
              <span>{{ item.regProvince | MapName(item.regCity, item.regArea) }}</span>
            </el-form-item>
          </el-col>
