        ...
        <el-row class="search-query">
              <el-col :span="22"
                ...
                :append-to-body="false"
                  v-model="searchData.supportLimit"
                  type="year"
                  value-format="yyyy"
                  class="pr20"
                  @change="()=>{this.pager.pageNum = 1;this.loadData()}"
                ...
                :popper-append-to-body="false"
                 v-model="searchData.area" placeholder="请选择" class="sel-layout" @change="()=>{this.pager.pageNum = 1;this.loadData()}">
                  <el-option
...
import { getBBsColumnList,getPolicyList } from '@/api/bbshall'
  ...
  methods: {
    loadData () {
      ...
      getPolicyList({ ...formpage,...this.searchData }).then(res => {
        if(res.code=='0000') {
          this.listData=res.rows[0].hotList
