  ...
  <el-main>
    <el-row class="content">
      <el-col :span="18" class="left-layout">
        <el-card :body-style="{ padding: '0 20px' }" shadow="never" class="inner_card">
      ...
      <el-col :span="6">
        ...
        shadow="never" class="bottom-card">
          <div slot="header">
...
import { getBBsDetail, getBBsIndustry, getBBsIndustryList, getBBsList ,getBBsDetailWYB} from '@/api/bbshall'
