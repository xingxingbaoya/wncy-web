  ...
  <el-main>
    ...
    <div class="content_main">
      ...
      <div class="content_c">
        <div class="more_cw">
          <div>会议新闻</div>
          <div v-if="totalCount>10 && activeName !=='2'"
               @click="checkMore">查看更多</div>
        </div>
        <currentYear @getNewsTotal="getNewsTotal"
                     v-if="activeName==1"></currentYear>
        <meet v-if="activeName==2"></meet>
      </div>
      <!-- <div class="right_content">
        <img src="../../assets/img/tcleft.png"
             alt="">
      </div> -->
    </div>
...
export default {
  ...
  methods: {
    ...
    loadData () {
      ...
      const formpage={ pageNum: 1,pageSize: 8 }
      this.loading=true
...
.search-area {
  ...
  // margin-bottom: 24px;
  background: url("../../assets/img/zgcdh1.png") no-repeat center 0px;
