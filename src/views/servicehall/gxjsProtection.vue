 ...
 <template>
  <div class="content">
    <el-row class="search-area">
      <el-input v-model="searchData.serviceName" placeholder="请输入关键字进行搜索" class="input-search">
    ...
    <!-- <el-row class="header_cont">
      <div class="header_box">
        <div class="header_box_left">
          <div v-for="(item,index) in meetingAgendaVOList"
               :key=index
               class="items"
               @click=checkTab(item.serviceType2)>
            <div class="item_img">
              <img :src="item.classifyImgActivity"
                   alt="">
            </div>
...
export default {
  ...
  data () {
    return {
      ...
      checkIndex: 0,
      dataTab: [
        { name: "集成电路",src: require("../../assets/img/tcc55.png") },
        { name: "集成电路",src: require("../../assets/img/tcc55.png") },
        { name: "集成电路",src: require("../../assets/img/tcc55.png") },
        { name: "集成电路",src: require("../../assets/img/tcc55.png") },
        { name: "集成电路",src: require("../../assets/img/tcc55.png") },
  ...
  methods: {
    checkTab (id) {
      ...
      this.searchDataTab.serviceType2=id
      this.loadDataFromTab()
    },
    loadDataFromTab () {
    ...
    loadDataType () {
      this.loading=true
      getServiceTypeListTwo({ classifyId: 6 }).then(res => {
        if(res.code=='0000') {
          this.dataType=res.obj.meetingAgendaVOListAll
          this.meetingAgendaVOList=res.obj.meetingAgendaVOList
  ...
  .header_box {
    ...
    .header_box_left {
      ...
      .items {
        ...
        background: #ffffff;
        box-shadow: 0px 0px 12px 0px #ebeefa;
        border-radius: 5px;
        margin-bottom: 5px;
        .item_img {
          img {
